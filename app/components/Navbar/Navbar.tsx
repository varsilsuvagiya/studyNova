                    ...
                    <div className="relative flex h-20 items-center justify-between">
                        <div className="flex flex-1 items-center sm:items-stretch sm:justify-start">
                            ...
                            <div className="flex flex-shrink-0 items-center">
                                <h1 style={{fontSize:"30px", fontWeight:"bold", }}  className="block h-30px w-30px lg:hidden">StudyNova</h1>
                                ...
                                style={{height:"70px", width:"150px"}}
                                    className="object-cover hidden h-48px w-48px lg:block"
                                    src={'/assets/logo/3.png'}
                                    alt="Courses-Logo"
                                /> */}
                            <h1 style={{fontSize:"30px", fontWeight:"bold", }}  className="hidden h-48px w-48px lg:block">StudyNova</h1>
                            </div>
