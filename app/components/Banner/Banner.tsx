            ...
            <div className="relative px-6 lg:px-8">
                <div className="mx-auto max-w-5xl pt-16 sm:pt-40 sm:pb-24">
                    <div className="text-center">
                        <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-75px md:4px style">
                            Boost your engineering skills  <br />with our advanced courses
                        </h1>
                        <p className="mt-6 text-lg leading-8 text-black">
                            Develop your skills through our courses and mentorship from top-tier companies.
                        </p>
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            ...
                            <div className='bannerBorder sm:pl-8'>
                                ...
                                <div>
                                    <h3 className='text-sm'>Rated by 18k on google.</h3>
                                </div>
                            </div>
                        </div>
                    </div>
