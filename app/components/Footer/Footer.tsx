    ...
    return (
        <div className="bg-bgpurple -mt-64" id="first-section">
                ...
                <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
                    ...
                    <div className='col-span-4'>
                        {/* <img src={'/assets/logo/Logo.png'} alt="logo" className='pb-4' /> */}
                         <h1 style={{fontSize:"50px", fontWeight:"bold",color:"white" }}  className="pb-4">StudyNova</h1>

                        <h3 className='text-white text-lg font-medium leading-9 mb-4 lg:mb-20'> "Enhance your skills and secure <br/> your dream job with enthusiasm." </h3>
            ...
            <div className='pb-24 px-4'>
                <h3 className='text-center text-offwhite'>@2023 - All Rights Reserved by <Link href="https://lathiyasolutions.com/" target="_blank"> Lathiya Solution</Link></h3>
            </div>
